...
<!-- STEP 3: Build a NAV element for global Web site navigation -->
			<nav>
				<ul>
					...
					<li><a href="about.php" title="Learn about blocks">About</a></li>
				</ul>
			</nav>
...
<!-- STEP 8a: Create a NAV element in the FOOTER for the legal stuff -->
			<nav>
				...
				<li><a href="about/terms-of-use.php" title="How to terms-of-use ">Terms of Use</a> | <a href="about/terms-of-use.php#limitation-liability" title="Learn about how limitation liability works">Terms of Use</a><li>
			</nav>
